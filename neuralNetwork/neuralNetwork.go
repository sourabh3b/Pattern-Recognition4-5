...
//NeuralNetwork - data structure for Neural Network
...
func NewNetwork(iInputCount, iHiddenCount, iOutputCount int, iRegression bool, learningRate, iRate2 float64) *NeuralNetwork {

	//increment input layer count by 1
	iInputCount += 1
	iHiddenCount += 1
	...
	network := &NeuralNetwork{
		...
		HiddenLayer: make([]float64, iHiddenCount),
